...
internal sealed class Emitter
{
    ...
    /// <summary>
    /// Writes the header. The context file gets all of it; a type file gets the auto-generated notice and the compiler
    /// directives, leaving out the block comment that describes the context, which lives in the context file alone.
    /// </summary>
    private void EmitHeader(Dictionary<string, string> values, bool contextFile)
    {
        ...
        {
            // The block comment and the blank line after it.
            if (!contextFile && i >= infoStart && i <= infoEnd + 1)
                continue;
