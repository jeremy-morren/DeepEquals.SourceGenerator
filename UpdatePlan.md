...
grew with files times roots; step 14 fixed that, and the 2,000-class closure now generates 25.3 MB with one root or
every type a root (§9.3). A cancellation 20 ms in returns after about 51 ms.
