...
|--------------------------------|-----------|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `MaxSwitchCases`               | 12        | ≥ 1                     | Exact dispatch cases above which a polymorphic core switches from an `if` chain to a dictionary lookup and `switch`; the common built-in leaves and up to this many of the closure's own types stay in the chain ahead of the lookup.                                                                                                                                                                                                    |
